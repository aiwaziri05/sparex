    ...
    <div class="max-w-7xl mx-auto px-6 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8 lg:col-span-1">
                <div class="space-y-2">
                    <h1 class="text-5xl lg:text-6xl font-black leading-tight text-gray-900 tracking-wide lg:tracking-wider">
                        Transform Your Business<span class="lg:block"></span>with AI-Powered Intelligence
                    </h1>
                    <p class="text-xl text-gray-600 leading-relaxed max-w-lg">
                        Unlock actionable insights and automate workflows with intelligent solutions designed for modern enterprises.
                    </p>
                </div>
                ...
                <div class="flex items-center gap-6 pt-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Businesses Transformed</p>
                    </div>
                    <div class="w-px h-12 bg-gray-200"></div>
                    <div>
                        <p class="text-sm font-semibold text-gray-900">99.9%</p>
                        <p class="text-sm text-gray-600">Uptime Guaranteed</p>
                    </div>
                </div>
            </div>

            <!-- Right Column: Hero Illustration (New Design) -->
            <div class="hidden lg:flex justify-center items-center lg:col-span-1">
                <x-illustrations.hero />
            </div>
