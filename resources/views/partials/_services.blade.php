...
<section id="services" class="py-20" style="background: linear-gradient(to bottom, #ffffff, #f5f5f5);">
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- Card: Custom Software Development -->
      <article class="service-card bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:border-transparent">
        <div class="flex items-start gap-4">
          <div class="service-icon" style="background: rgba(25, 118, 210, 0.15);">
            <img src="{{ asset('assets/icons/laptop.svg') }}" alt="Custom Software">
          </div>
          <div>
      ...
      <!-- Card: Digital SOP Systems -->
      <article class="service-card bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:border-transparent">
        <div class="flex items-start gap-4">
          <div class="service-icon" style="background: rgba(79, 70, 229, 0.15);">
            <img src="{{ asset('assets/icons/checklist.svg') }}" alt="Digital SOP">
          </div>
          <div>
      ...
      <article class="service-card bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:border-transparent">
        <div class="flex items-start gap-4">
          <div class="service-icon" style="background: rgba(255, 152, 0, 0.15);">
            <img src="{{ asset('assets/icons/cog.svg') }}" alt="Automation">
          </div>
          <div>
      ...
      <article class="service-card bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:border-transparent">
        <div class="flex items-start gap-4">
          <div class="service-icon" style="background: rgba(16, 185, 129, 0.15);">
            <img src="{{ asset('assets/icons/database.svg') }}" alt="Data Management">
          </div>
          <div>
      ...
      <!-- Card: Document Digitalization -->
      <article class="service-card bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:border-transparent">
        <div class="flex items-start gap-4">
          <div class="service-icon" style="background: rgba(79, 70, 229, 0.15);">
            <img src="{{ asset('assets/icons/document.svg') }}" alt="Document Digitalization">
          </div>
          <div>
      ...
      <!-- Card: IT Infrastructure Advisory -->
      <article class="service-card bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:border-transparent">
        <div class="flex items-start gap-4">
          <div class="service-icon" style="background: rgba(79, 70, 229, 0.15);">
            <img src="{{ asset('assets/icons/server.svg') }}" alt="Infrastructure Advisory">
          </div>
          <div>
