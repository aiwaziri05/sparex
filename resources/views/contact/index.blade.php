                ...
                <div>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center flex-shrink-0 text-blue-400">
                            ...
                            <div>
                                ...
                                <a href="mailto:hello@sparex.com" class="text-gray-400 hover:text-white transition-colors">hello@sparex.com</a>
                                <p class="text-sm text-gray-500 mt-1">We'll get back to you within 24 hours.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-4">
                            <div class="w-12 h-12 rounded-xl bg-slate-800 flex items-center justify-center flex-shrink-0 text-indigo-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            ...
                            <div>
                                ...
                                <a href="tel:+15550000000" class="text-gray-400 hover:text-white transition-colors">+1 (555) 000-0000</a>
                    ...
                    <div class="mt-12 pt-12 border-t border-slate-800">
                        ...
                        <div class="flex gap-4">
                            <a href="#" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-white hover:text-slate-900 transition-all duration-300">
